...
export default function Page({ params }: { params: { slug: string, sections: Section[]; } }) {
      ...
      <div className="relative bg-white md:bg-[#f1f5f9] md:w-[75%] -mt-[15px] md:-mt-[65px] p-4 md:p-6 rounded-2xl md:rounded-none shadow-xl mx-auto">
        ...
        <div className="relative w-full md:w-[100%] h-[300px] md:h-[350px] rounded-xl overflow-hidden shadow-2xl mx-auto">
          ...
          <Image
            ...
            alt={`Anti Bird Net installation in ${page.location}`}
            title={`Anti bird Net installation near me in ${page.location}`}
            fill
  ...
  bg-black/10
    mb-3  rounded-full"></div>
            ...
            {section.heading.includes("How Anti Bird Nets Stop Pigeons") && (
              <div className="relative w-full h-[260px] md:h-[320px] my-6 rounded-xl overflow-hidden">
                ...
                <Image
                  ...
                  alt={`Anti bird Net installation near me ${page.location}`}
                  title={`Anti bird Net installation near me in ${page.location} Hyderabad`}
                  fill
                  className="object-cover transition-transform duration-700 hover:scale-105"
                  priority
                />
      ...
      <section className="bg-[#344A6C] text-white py-14">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <h2 className="text-3xl font-bold mb-4">
            Need Anti bird Net in {page.location}?
          </h2>

          <p className="mb-6">
            Contact Rohini Invisible Grills today for professional installation for your balcony.
