  ...
  return (
    <div className="fixed right-4 top-1/2 -translate-y-1/2 flex flex-col gap-3 z-50">
      ...
      >
        ...
        >
          <path
            d="M22 16.92v3a2 2 0 0 1-2.18 2 19.8 19.8 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.8 19.8 0 0 1 3.08 4.18 2 2 0 0 1 5 2h3a2 2 0 0 1 2 1.72c.12.97.39 1.92.78 2.79a2 2 0 0 1-.45 2.11L9.91 10.09a16 16 0 0 0 6 6l1.47-1.47a2 2 0 0 1 2.11-.45c.87.39 1.82.66 2.79.78A2 2 0 0 1 22 16.92z"
            stroke="#fff"
            strokeWidth="1.2"
            strokeLinecap="round"
